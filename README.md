...
- **แปลงรวมเลขหน้าและเลขหัวข้อแบบ Flatten**: แปลงและแช่แข็งตัวเลขในหัวกระดาษ, เลขหน้า และลำดับรายการอัตโนมัติ (จะกลายเป็นข้อความถาวร)

## การเปลี่ยนโลโก้ (How to Change Logo)
หากต้องการเปลี่ยนรูปไอคอนที่ปรากฏใน Word:
1. สร้างไฟล์รูปภาพ PNG ขนาด **300x300 pixels** พร้อมดีไซน์ "IT๙" ของคุณ
2. บันทึกทับไฟล์เดิมที่ **`public/icon.png`** ในโฟลเดอร์โปรเจกต์นี้
3. **Push** การเปลี่ยนแปลงขึ้น GitHub
4. เมื่อ Deploy เสร็จแล้ว ให้ปิดและเปิดโปรแกรม Word ใหม่
